...
namespace CrazyGames
{
    ...
    {
        public const string sitelockVersion = "1.9.0";
        ...
        {
            CrazySDK.SiteLockFreezeGame(code);
        }
        ...
        public static bool IsOnWhitelistedDomain()
        {
            ...
            if (settings == null || settings.whitelistedDomains == null)
                return false;
        ...
        {
            var crazySettings = Resources.Load<CrazySettings>("CrazyGamesSettings");
            if (crazySettings == null)
            {
                Debug.LogError("Missing CrazySDK/Resources/CrazyGamesSettings file. Please be sure you imported the SDK correctly.");
                return null;
            }
